...
def process_price(price, ts=None):
...
def load_history():
    global last_close, renko_bars
    print("Loading historical LTCUSDT data from Binance...")
    try:
        ...
        print(f"History loaded: {len(renko_bars)} Renko bars built")
...
<div id="chart-container">
  <div id="loading">
    ...
    <p>Fetching last 1000 candles from Binance</p>
  </div>
